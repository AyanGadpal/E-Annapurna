...
<%
    ...
    //int pan = Integer.parseInt(DonorPan);  
    try{
        ...
        st.executeUpdate("insert into donor(DonateAmt,DonorPan,DonorName,DonateAddr)values("+DonateAmt+",'"+DonorPan+"','"+DonorName+"','"+DonateAddr+"')");
