...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_MONTHWISEDONOR` ()  BEGIN
    declare date_month varchar(10) default 0;
    DECLARE finished INTEGER DEFAULT 0;
    declare month_8 int default 0;
    declare month_9 int default 0;
    declare month_10 int default 0;
  
    DECLARE cursor_name1 CURSOR FOR select date_tran from donor;
    ...
    getMonth: LOOP
    FETCH cursor_name1 INTO date_month;
    ...
    if MONTH(date_month) = 8 then
       set month_8 = month_8 + 1;
     end if;
    if MONTH(date_month) = 9 then
       set month_9 = month_9 + 1;
     end if;
      if MONTH(date_month) = 10 then
       set month_10 = month_10 + 1;
     end if;

    END LOOP getMonth;
    CLOSE cursor_name1;

    select month_8,month_9,month_10;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `reset_volunteer_state` ()  BEGIN  
   UPDATE volunteer set STATUS=0 WHERE v_id in (SELECT v_id from vol_allocation);
END$$
...
(1, 1, 1, 'Home of Love', 18, 'orphange', 2147483647, 10, 12, 12, 11, 22, '0000-00-00'),
(2, 2, 2, 'Aadarana', 20, 'old age home', 2147483647, 16, 32, 23, 12, 1, '0000-00-00'),
(1, 3, 1, 'anand public school', 15.6, 'education institue', 2147483647, 31, 2, 11, 13, 12, '0000-00-00'),
(2, 4, 3, 'Janahita Vatsalya Project', 13.2, ' night shelter home', 2147483647, 23, 6, 17, 1, 14, '0000-00-00'),
(2, 5, 3, 'Shejar Chhaya', 23.5, 'nursery', 2147483647, 15, 43, 3, 14, 23, '0000-00-00'),
(2, 6, 1, 'New Dawn Trust', 18.9, 'other', 2147483647, 26, 23, 6, 21, 5, '0000-00-00'),
(1, 7, 3, 'Purbachal Ananda Foundati', 31.5, 'orphange', 2147483647, 18, 43, 9, 22, 32, '0000-00-00'),
(2, 8, 4, 'Mitra Jyothi', 30.9, 'old age home', 2147483647, 3, 11, 32, 23, 32, '0000-00-00'),
(1, 9, 3, 'Agappe Educational and Ch', 22.7, 'education institue', 2147483647, 5, 21, 26, 24, 2, '0000-00-00'),
(1, 10, 2, ' Aasha Social Welfare Ass', 15.7, ' night shelter home', 2147483647, 11, 1, 15, 15, 13, '0000-00-00'),
(2, 11, 3, 'St. Mary\'s (Girls) Orphan', 18.1, 'nursery', 2147483647, 7, 16, 12, 16, 14, '0000-00-00'),
(1, 12, 2, 'Nativity Girl\'s Orphanage', 20.8, 'other', 2147483647, 8, 18, 17, 17, 15, '0000-00-00'),
(2, 13, 4, 'St. Peter\'s Orphanage (Gi', 32.6, 'orphange', 2147483647, 11, 23, 31, 32, 16, '0000-00-00'),
(1, 14, 4, 'Presentation Girls Orphan', 21.4, 'old age home', 2147483647, 22, 26, 27, 2, 17, '0000-00-00'),
(2, 15, 2, 'St. John Bosco Orphanage ', 22.1, 'education institue', 2147483647, 26, 23, 22, 5, 21, '0000-00-00'),
(2, 16, 3, 'St. John Vianney Orphanag', 20.6, ' night shelter home', 2147483647, 17, 15, 27, 3, 22, '0000-00-00'),
(2, 17, 1, 'Epiphany Children\'s Home ', 24.8, 'nursery', 2147483647, 16, 16, 25, 23, 11, '0000-00-00'),
(1, 18, 3, 'Umsohlait Mawhati Welfare', 20.5, 'other', 2147483647, 14, 17, 11, 22, 12, '0000-00-00'),
(2, 19, 1, 'S.F.S. Girls Home', 13.1, 'orphange', 2147483647, 2, 18, 14, 12, 1, '0000-00-00'),
(1, 20, 2, 'S.O.S. Children Village,', 28.7, 'old age home', 2147483647, 33, 21, 5, 32, 23, '0000-00-00'),
(2, 21, 1, 'Krist Syiem Social Welfar', 5.9, 'education institue', 2147483647, 27, 2, 2, 4, 2, '0000-00-00'),
(2, 22, 3, 'Lum Assisi Social Welfare', 8.6, ' night shelter home', 2147483647, 12, 3, 17, 2, 3, '0000-00-00'),
(1, 23, 4, 'Lum Assisi Social Welfare', 16.2, 'nursery', 2147483647, 27, 5, 24, 11, 3, '0000-00-00'),
(2, 24, 3, 'St. Theresa Girls Orphana', 19.7, 'other', 2147483647, 23, 4, 23, 22, 3, '0000-00-00'),
...
(6, 'CJHS5094AS', 'Bhagwati', '200.00', 'mumbai', '2019-09-09'),
(7, 'XJHU5692CH', 'Bimal ', '650.00', 'godiya', '2019-08-10'),
(8, 'FKOY6934VH', 'Binod', '200.00', 'kholapur', '2019-02-08'),
(9, 'XDNJ6753BH', 'Brijesh', '350.00', 'jalgon', '2019-08-10'),
...
(1, 1, 'Mandeep', 'restaurant', 2147483647, 'Mandeep', 0, 10, 0, '0000-00-00'),
(2, 3, 'Manpreet', 'hospital', 2147483647, 'Manpreet', 10000, 0, 0, '0000-00-00'),
(3, 2, 'Mrinal', 'rwa', 2147483647, 'Mrinal', 0, 0, 20, '0000-00-00'),
(4, 3, 'NITIN', 'event caterer', 2147483647, 'NITIN', 12000, 0, 0, '0000-00-00'),
(5, 1, 'Nachiketa ', 'factory', 2147483647, 'Nachiketa ', 0, 25, 0, '0000-00-00'),
(6, 2, 'Nakusha', 'hotel', 2147483647, 'Nakusha', 0, 0, 21, '0000-00-00'),
(7, 3, 'Narendran', 'individual', 2147483647, 'Narendran', 15000, 0, 0, '0000-00-00'),
(8, 2, 'Naresh', 'college', 2147483647, 'Naresh', 0, 13, 0, '0000-00-00'),
(9, 4, 'PRAMOD', 'social group', 2147483647, 'PRAMOD', 0, 0, 25, '0000-00-00'),
(10, 4, 'Pardeep', 'mess', 2035006370, 'Pardeep', 20000, 10, 0, '0000-00-00'),
(11, 2, 'Prabhakar', 'restaurant', 2147483647, 'Prabhakar', 0, 10, 10, '0000-00-00'),
(12, 4, 'Pranay', 'hospital', 2147483647, 'Pranay', 15000, 0, 30, '0000-00-00'),
(13, 2, 'Prasad ', 'rwa', 2147483647, 'Prasad ', 20000, 20, 0, '0000-00-00'),
(14, 4, 'Prasanta', 'event caterer', 2147483647, 'Prasanta', 0, 15, 15, '0000-00-00'),
(15, 2, 'RADHA', 'factory', 2147483647, 'RADHA', 15000, 0, 20, '0000-00-00'),
(16, 3, 'Raghava', 'hotel', 2147483647, 'Raghava', 30000, 30, 0, '0000-00-00'),
(17, 4, 'Raghavan', 'individual', 2147483647, 'Raghavan', 10000, 10, 10, '0000-00-00'),
(18, 4, 'Raja Babu', 'college', 2147483647, 'Raja Babu', 0, 20, 20, '0000-00-00'),
(19, 2, 'Rama Devi', 'social group', 2147483647, 'Rama Devi', 25000, 30, 30, '0000-00-00'),
(20, 1, 'ATHARVA', 'mess', 2147483647, 'ATHARVA', 0, 11, 11, '0000-00-00'),
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `spn_allocation` BEFORE INSERT ON `sponsors` FOR EACH ROW BEGIN
SET 
new.date_tran = now();
END
$$
...
(2, 1, 'Sanskriti', 'Agarwal', 1, 'Sanskriti', 2147483647, '01-10-1999', 'COEP', 'B.A', 'B', '1111001', 1, '2017-01-20'),
(3, 1, 'Manali', 'saraf', 1, 'Shachi', 2147483647, '30-09-1999', 'PVG', 'B.COM', 'C', '1000101', 1, '2017-01-30'),
(4, 1, 'Shakti', 'Aggarwal', 1, 'Shakti', 2147483647, '29-09-1999', 'PCCOE', 'LLB', 'D', '1010110', 2, '2017-04-10'),
(5, 1, 'Sheetal', 'Agrawal', 1, 'Sheetal', 2147483647, '28-09-1999', 'PPS', 'M.B.B.S', 'E', '1010101', 1, '2017-05-01'),
(6, 1, 'Shilpa', 'Ahluwalia', 1, 'Shilpa', 2147483647, '27-09-1989', 'RSCOE', 'B.A.M.S', 'A', '1111110', 2, '0000-00-00'),
(7, 1, 'Shivangi', 'Ahuja', 1, 'Shivangi', 2147483647, '28-09-1989', 'VJTI', 'DIPLOMA', 'B', '1111110', 2, '0000-00-00'),
(8, 1, 'Shreya', 'Amble', 1, 'Shreya', 2147483647, '29-09-1989', 'IIT BOMBAY', 'C.A', 'C', '1100101', 1, '0000-00-00'),
(9, 1, 'Shruti', 'Anand', 1, 'Shruti', 2147483647, '30-09-1989', 'IIT BOMBAY', 'B.E', 'D', '1111001', 0, '0000-00-00'),
(10, 1, 'Shubha', 'Andra', 1, 'Shubha', 2147483647, '01-10-1989', 'SIGHGAD', 'B.E', 'E', '1000101', 0, '0000-00-00'),
(11, 1, 'Shraddha', 'Anne', 1, 'Shraddha', 2147483647, '02-10-1989', 'TCS', 'B.A', 'A', '1010110', 2, '0000-00-00'),
(12, 1, 'Shweta', 'Apte', 1, 'Shweta', 2147483647, '03-10-1989', 'LTI', 'B.COM', 'B', '1010101', 0, '0000-00-00'),
(13, 1, 'Sneha', 'Arora', 1, 'Sneha', 2147483647, '04-10-1989', 'SAPIENT', 'LLB', 'C', '1111110', 2, '0000-00-00'),
(14, 1, 'Soumya', 'Arya', 1, 'Soumya', 2147483647, '05-10-1989', 'RAKUTEN', 'M.B.B.S', 'D', '1111110', 2, '0000-00-00'),
(15, 1, 'Sushma', 'Atwal', 1, 'Sushma', 2147483647, '06-10-1989', 'SE2', 'B.A.M.S', 'E', '1100101', 0, '0000-00-00'),
(16, 1, 'Swati', 'Aurora', 1, 'Swati', 2147483647, '06-11-1987', 'PUBMATIC', 'DIPLOMA', 'A', '1111001', 0, '0000-00-00'),
(17, 1, 'Aashu', 'Babu', 1, 'Aashu', 2147483647, '18-01-1987', 'FINSTA', 'C.A', 'B', '1000101', 0, '0000-00-00'),
(18, 1, 'Anamol', 'Badal', 1, 'Anamol', 2147483647, '01-04-1986', 'GLOBAL SOLUTION', 'B.E', 'C', '1010110', 2, '0000-00-00'),
(19, 1, 'Anish', 'Badami', 1, 'Anish', 2147483647, '13-06-1985', 'EQ TECH', 'B.E', 'D', '1010101', 0, '0000-00-00'),
(20, 2, 'Appa Rao', 'Bahl', 1, 'Appa Rao', 2147483647, '25-08-1984', 'TCS', 'B.A', 'E', '1111110', 2, '0000-00-00'),
(21, 2, 'Appayya', 'Bahri', 1, 'Appayya', 2147483647, '07-11-1983', 'LTI', 'B.COM', 'A', '1111110', 2, '0000-00-00'),
(22, 2, 'Arindam', 'Bawa', 1, 'Arindam', 2147483647, '19-01-1983', 'PICT', 'LLB', 'B', '1111110', 2, '0000-00-00'),
(23, 2, 'Aryaman', 'Bedi', 1, 'Aryaman', 2147483647, '02-04-1982', 'COEP', 'M.B.B.S', 'C', '1100101', 0, '0000-00-00'),
(24, 2, 'Aseem', 'Behl', 1, 'Aseem', 2147483647, '14-06-1981', 'PVG', 'B.A.M.S', 'D', '1111001', 0, '0000-00-00'),
(25, 2, 'Ashish', 'Ben', 1, 'Ashish', 2147483647, '26-08-1980', 'PCCOE', 'DIPLOMA', 'E', '1000101', 0, '0000-00-00'),
(26, 2, 'Sambasiva Rao', 'Bera', 1, 'Sambasiva Rao', 2147483647, '08-11-1979', 'PPS', 'C.A', 'A', '1010110', 2, '0000-00-00'),
(27, 2, 'Santosh', 'Bhagat', 1, 'Santosh', 2147483647, '20-01-1979', 'RSCOE', 'B.E', 'B', '1010101', 0, '0000-00-00'),
(28, 2, 'Shambhav', 'Bhakta', 1, 'Shambhav', 2035006370, '03-04-1978', 'VJTI', 'B.E', 'C', '1111110', 2, '0000-00-00'),
(29, 2, 'Shashi', 'Bhalla', 1, 'Shashi', 2147483647, '15-06-1977', 'IIT BOMBAY', 'B.A', 'D', '1111110', 2, '0000-00-00'),
(30, 2, 'Shirish ', 'Bhandari', 1, 'Shirish ', 2147483647, '27-08-1976', 'IIT BOMBAY', 'B.COM', 'E', '1100101', 0, '0000-00-00'),
(31, 2, 'Shyam', 'Bhardwaj', 1, 'Shyam', 2147483647, '09-11-1975', 'SIGHGAD', 'LLB', 'A', '1111001', 0, '0000-00-00'),
(32, 2, 'Sikkil', 'Bhargava', 1, 'Sikkil', 2147483647, '21-01-1975', 'TCS', 'M.B.B.S', 'B', '1000101', 0, '0000-00-00'),
(33, 2, 'Sitaram', 'Bhasin', 1, 'Sitaram', 2147483647, '04-04-1974', 'LTI', 'B.A.M.S', 'C', '1010110', 2, '0000-00-00'),
(34, 2, 'Siva Rao ', 'Bhat', 1, 'Siva Rao ', 2147483647, '16-06-1973', 'SAPIENT', 'DIPLOMA', 'D', '1010101', 0, '0000-00-00'),
(35, 2, 'Sonal', 'Bhatia', 1, 'Sonal', 2147483647, '28-08-1972', 'RAKUTEN', 'C.A', 'E', '1111110', 2, '0000-00-00'),
(36, 2, 'Sreedharan', 'Bhatnagar', 1, 'Sreedharan', 2147483647, '10-11-1971', 'SE2', 'B.E', 'A', '1111110', 2, '0000-00-00'),
(37, 2, 'Subramaniam', 'Bhatt', 1, 'Subramaniam', 2147483647, '22-01-1971', 'PUBMATIC', 'B.E', 'B', '1100101', 0, '0000-00-00'),
(38, 2, 'Sukhdev ', 'Bhattacharyya', 1, 'Sukhdev ', 2147483647, '01-10-1972', 'FINSTA', 'B.A', 'C', '1111001', 0, '0000-00-00'),
(39, 2, 'Nishant ', 'Bhatti', 1, 'Nishant ', 2147483647, '11-06-1974', 'GLOBAL SOLUTION', 'B.COM', 'D', '1000101', 0, '0000-00-00'),
(40, 2, 'Suryanarayana', 'Bhavsar', 1, 'Suryanarayana', 2147483647, '19-02-1976', 'EQ TECH', 'LLB', 'E', '1010110', 2, '0000-00-00'),
(41, 2, 'ayan ', 'Bir', 1, 'ayan ', 2147483647, '29-10-1977', 'TCS', 'M.B.B.S', 'A', '1010101', 0, '0000-00-00'),
(42, 2, 'Babu ', 'Biswas', 1, 'Babu ', 2147483647, '09-07-1979', 'LTI', 'B.A.M.S', 'B', '1111110', 2, '0000-00-00'),
(43, 2, 'Balasubramaniam', 'Boase', 1, 'Balasubramaniam', 2147483647, '18-03-1981', 'SANSTHA PANGAON', 'DIPLOMA', 'C', '1111110', 2, '0000-00-00'),
(44, 2, 'Bhagwati', 'Bobal', 1, 'Bhagwati', 2147483647, '26-11-1982', 'NORTH EAST MULTIPURPOSE', 'C.A', 'D', '1100101', 0, '0000-00-00'),
(45, 2, 'Bimal ', 'Bora', 1, 'Bimal ', 2147483647, '05-08-1984', 'SANJOGA', 'B.E', 'E', '1111001', 0, '0000-00-00'),
(46, 2, 'Binod', 'Bora', 1, 'Binod', 2147483647, '15-04-1986', 'SOCIETY KARNATAKA ', 'B.E', 'A', '1000101', 0, '0000-00-00'),
(47, 2, 'Brijesh', 'Borah', 1, 'Brijesh', 2147483647, '24-12-1987', 'SVOJAS FOUNDATION', 'B.A', 'B', '1010110', 2, '0000-00-00'),
(48, 2, 'dnyanu', 'Borde', 1, 'dnyanu', 2147483647, '02-09-1989', 'Ummat-e- Muhammadiya', 'B.COM', 'C', '1010101', 0, '0000-00-00'),
(49, 2, 'Chandramouli', 'Borra', 1, 'Chandramouli', 2147483647, '13-05-1991', 'PICT', 'LLB', 'D', '1111110', 2, '0000-00-00'),
(50, 2, 'Chetan ', 'Bose', 1, 'Chetan ', 2147483647, '20-01-1993', 'COEP', 'M.B.B.S', 'E', '1111110', 2, '0000-00-00'),
(51, 2, 'kalpit', 'Brahmbhatt', 1, 'kalpit', 2147483647, '30-09-1994', 'PVG', 'B.A.M.S', 'A', '1100101', 0, '0000-00-00'),
(52, 2, 'Deepan', 'Brar', 1, 'Deepan', 2147483647, '09-06-1996', 'PCCOE', 'DIPLOMA', 'B', '1111001', 0, '0000-00-00'),
(53, 2, 'MANSI', 'Buch', 1, 'MANSI', 2147483647, '17-02-1998', 'PPS', 'C.A', 'C', '1000101', 0, '0000-00-00'),
(54, 3, 'Gautam ', 'Buch', 1, 'Gautam ', 2147483647, '08-07-1997', 'RSCOE', 'B.E', 'D', '1010110', 2, '0000-00-00'),
(55, 3, 'Ghantasala', 'Bumb', 1, 'Ghantasala', 2147483647, '26-11-1996', 'VJTI', 'B.E', 'E', '1010101', 0, '0000-00-00'),
(56, 3, 'ROHAN', 'Butala', 1, 'ROHAN', 2147483647, '16-04-1996', 'IIT BOMBAY', 'B.A', 'A', '1111110', 2, '0000-00-00'),
(57, 3, 'Hanumantha Rao', 'Chacko', 1, 'Hanumantha Rao', 2147483647, '05-09-1995', 'IIT BOMBAY', 'B.COM', 'B', '1111110', 2, '0000-00-00'),
(58, 3, 'Harbhajan', 'Chad', 1, 'Harbhajan', 2147483647, '24-01-1995', 'SIGHGAD', 'LLB', 'C', '1100101', 0, '0000-00-00'),
(59, 3, 'Harikrishna', 'Chada', 1, 'Harikrishna', 2147483647, '14-06-1994', 'TCS', 'M.B.B.S', 'D', '1111001', 0, '0000-00-00'),
(60, 3, 'OMKAR', 'Chadha', 1, 'OMKAR', 2147483647, '02-11-1993', 'LTI', 'B.A.M.S', 'E', '1000101', 0, '0000-00-00'),
(61, 3, 'Ishwar ', 'Chahal', 0, 'Ishwar ', 2147483647, '23-03-1993', 'SAPIENT', 'DIPLOMA', 'A', '1010110', 2, '0000-00-00'),
(62, 3, 'ADITYA', 'Chakrabarti', 0, 'ADITYA', 2147483647, '11-08-1992', 'RAKUTEN', 'C.A', 'B', '1010101', 0, '0000-00-00'),
(63, 3, 'Jaisingrao', 'Chakraborty', 0, 'Jaisingrao', 2147483647, '31-12-1991', 'SE2', 'B.E', 'C', '1111110', 2, '0000-00-00'),
(64, 3, 'Jayendra', 'Chana', 0, 'Jayendra', 2147483647, '21-05-1991', 'PUBMATIC', 'B.E', 'D', '1111110', 2, '0000-00-00'),
(65, 3, 'Jeona', 'Chand', 0, 'Jeona', 2147483647, '09-10-1990', 'FINSTA', 'B.A', 'E', '1100101', 0, '0000-00-00'),
(66, 3, 'Jigar ', 'Chanda', 0, 'Jigar ', 2147483647, '27-02-1990', 'GLOBAL SOLUTION', 'B.COM', 'A', '1111001', 0, '0000-00-00'),
(67, 3, 'Jitu ', 'Chander', 0, 'Jitu ', 2147483647, '18-07-1989', 'EQ TECH', 'LLB', 'B', '1000101', 0, '0000-00-00'),
(68, 3, 'KETAN', 'Chandra', 0, 'KETAN', 2147483647, '06-12-1988', 'TCS', 'M.B.B.S', 'C', '1010110', 2, '0000-00-00'),
(69, 3, 'Keki', 'Chandran', 0, 'Keki', 2147483647, '26-04-1988', 'LTI', 'B.A.M.S', 'D', '1010101', 0, '0000-00-00'),
(70, 3, 'Keshavadasa', 'Char', 0, 'Keshavadasa', 2147483647, '15-09-1987', 'SANSTHA PANGAON', 'DIPLOMA', 'E', '1111110', 2, '0000-00-00'),
(71, 3, 'Krishna Das', 'Chatterjee', 0, 'Krishna Das', 2147483647, '03-02-1987', 'NORTH EAST MULTIPURPOSE', 'C.A', 'A', '1111110', 2, '0000-00-00'),
(72, 3, 'Krishnamurti', 'Din', 0, 'Krishnamurti', 2147483647, '24-06-1986', 'SANJOGA', 'B.E', 'B', '1100101', 0, '0000-00-00'),
(73, 3, 'Kushal ', 'Divan', 0, 'Kushal ', 2147483647, '12-11-1985', 'SOCIETY KARNATAKA ', 'B.E', 'C', '1111001', 0, '0000-00-00'),
(74, 3, 'Kutumba Rao', 'Dixit', 0, 'Kutumba Rao', 2147483647, '02-04-1985', 'SVOJAS FOUNDATION', 'B.A', 'D', '1000101', 0, '0000-00-00'),
(75, 3, 'SHARDUL', 'Doctor', 0, 'SHARDUL', 2147483647, '21-08-1984', 'Ummat-e- Muhammadiya', 'B.COM', 'E', '1010110', 2, '0000-00-00'),
(76, 3, 'Lakshmikantam', 'Dora', 0, 'Lakshmikantam', 2147483647, '10-01-1984', 'PICT', 'LLB', 'A', '1010101', 0, '0000-00-00'),
(77, 4, 'Lal', 'Doshi', 0, 'Lal', 2147483647, '31-05-1983', 'COEP', 'M.B.B.S', 'B', '1111110', 2, '0000-00-00'),
(78, 4, 'MAYANK', 'Dua', 0, 'MAYANK', 2147483647, '19-10-1982', 'PVG', 'B.A.M.S', 'C', '1111110', 2, '0000-00-00'),
(79, 4, 'Mandar ', 'Dube', 0, 'Mandar ', 2147483647, '09-03-1982', 'PCCOE', 'DIPLOMA', 'D', '1100101', 0, '0000-00-00'),
(80, 4, 'Mandeep', 'Dubey', 0, 'Mandeep', 2147483647, '28-07-1981', 'PPS', 'C.A', 'E', '1111001', 0, '0000-00-00'),
(81, 4, 'Manpreet', 'Dugal', 0, 'Manpreet', 2147483647, '16-12-1980', 'RSCOE', 'B.E', 'A', '1000101', 0, '0000-00-00'),
(82, 4, 'Mrinal', 'Dugar', 0, 'Mrinal', 2147483647, '06-05-1980', 'VJTI', 'B.E', 'B', '1010110', 2, '0000-00-00'),
(83, 4, 'NITIN', 'Dugar', 0, 'NITIN', 2147483647, '25-09-1979', 'IIT BOMBAY', 'B.A', 'C', '1010101', 0, '0000-00-00'),
(84, 4, 'Nachiketa ', 'Dutt', 0, 'Nachiketa ', 2147483647, '26-10-1979', 'IIT BOMBAY', 'B.COM', 'D', '1111110', 2, '0000-00-00'),
(85, 4, 'Nakusha', 'Dutta', 0, 'Nakusha', 2147483647, '27-10-1979', 'SIGHGAD', 'LLB', 'E', '1111110', 2, '0000-00-00'),
(86, 4, 'Narendran', 'Dyal', 0, 'Narendran', 2147483647, '28-10-1979', 'TCS', 'M.B.B.S', 'A', '1100101', 0, '0000-00-00'),
(87, 4, 'Naresh', 'Edwin', 0, 'Naresh', 2147483647, '29-10-1979', 'LTI', 'B.A.M.S', 'B', '1111001', 0, '0000-00-00'),
(88, 4, 'PRAMOD', 'Gaba', 0, 'PRAMOD', 2147483647, '30-10-1979', 'SAPIENT', 'DIPLOMA', 'C', '1000101', 0, '0000-00-00'),
(89, 4, 'Pardeep', 'Gade', 0, 'Pardeep', 2147483647, '31-10-1979', 'RAKUTEN', 'C.A', 'D', '1010110', 2, '0000-00-00'),
(90, 4, 'Prabhakar', 'Gala', 0, 'Prabhakar', 2147483647, '01-11-1979', 'SE2', 'B.E', 'E', '1010101', 0, '0000-00-00'),
(91, 4, 'Pranay', 'Gandhi', 0, 'Pranay', 2147483647, '02-11-1979', 'PUBMATIC', 'B.E', 'A', '1111110', 2, '0000-00-00'),
(92, 4, 'Prasad ', 'Ganesan', 0, 'Prasad ', 2147483647, '03-11-1979', 'FINSTA', 'B.A', 'B', '1111110', 2, '0000-00-00'),
(93, 4, 'Prasanta', 'Ganesh', 0, 'Prasanta', 2147483647, '04-11-1979', 'GLOBAL SOLUTION', 'B.COM', 'C', '1100101', 0, '0000-00-00'),
(94, 4, 'RADHA', 'Ganguly', 0, 'RADHA', 2147483647, '05-11-1979', 'EQ TECH', 'LLB', 'D', '1111001', 0, '0000-00-00'),
(95, 4, 'Raghava', 'Gara', 0, 'Raghava', 2147483647, '06-11-1979', 'TCS', 'M.B.B.S', 'E', '1000101', 0, '0000-00-00'),
(96, 4, 'Raghavan', 'Garde', 0, 'Raghavan', 2147483647, '07-11-1979', 'LTI', 'B.A.M.S', 'A', '1010110', 2, '0000-00-00'),
(97, 4, 'Raja Babu', 'Garg', 0, 'Raja Babu', 2147483647, '08-11-1979', 'SANSTHA PANGAON', 'DIPLOMA', 'B', '1010101', 0, '0000-00-00'),
(98, 4, 'Rama Devi', 'Gera', 0, 'Rama Devi', 2147483647, '09-11-1979', 'NORTH EAST MULTIPURPOSE', 'C.A', 'C', '1111110', 2, '0000-00-00'),
(99, 4, 'ATHARVA', 'Ghose', 0, 'ATHARVA', 2147483647, '10-11-1979', 'SANJOGA', 'B.E', 'D', '1111110', 2, '0000-00-00'),
(100, 4, 'ANIKET', 'Ghosh', 0, 'ANIKET', 2147483647, '11-11-1979', 'SOCIETY KARNATAKA ', 'B.A', 'E', '1100101', 0, '0000-00-00'),
(101, 1, 'manasi', 'chikorde', 0, 'chikorde@gmail.com', 1234543215, '2000-01-14', 'abcdefg', 'hdfdfdf', 'asdfghjjjjj', '0011001', 0, '2019-10-10'),
...
--
DELIMITER $$
CREATE TRIGGER `vol_allo` BEFORE INSERT ON `volunteer` FOR EACH ROW begin set
new.date_tran = now();
end
$$
DELIMITER ;
...
--
ALTER TABLE `allocation`
  MODIFY `AllID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
