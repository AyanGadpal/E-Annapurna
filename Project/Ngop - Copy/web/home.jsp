...
<head>
    ...
    <body>
              ...
              <div class="container-fluid">
                <div class="header-wrap">
                  <div class="header-button">
                    <h1>Analysis</h1>
                    <button type="submit" style="margin-left:700px;" onclick="generatePDF()" class="au-btn au-btn-icon au-btn--blue au-btn--small">Download Report </button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">                                  
        ...
        <div class="col-lg-6">
           ...
           <div id="invoice" class="au-card m-b-30">                                  

            <h1 class="title-2 ">Food Request</h1>
  ...
  <script>
    ...
    var myChart2 = new Chart(ctx2, {
      type: 'doughnut',
      data: {
        labels: ['Katraj', 'Wakad', 'Swargate', 'Shivaji Nagar'],
