...
A=null;
A = st.executeQuery("SELECT * from consumer ORDER BY Quantity DESC LIMIT 10");
float arr[];
arr = new float[10];
String list[];
list = new String[10];
...
while(A.next())
{
    arr[i] = A.getFloat("Quantity");
    list[i] = A.getString("hname");
    i++;    
}
    ...
    var myChart2 = new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
          ...
          label: '# Highest reuqested quantity',
