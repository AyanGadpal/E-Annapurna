...
<!DOCTYPE html>
 <%  
    ...
    ResultSet result = st.executeQuery("call PeopleServedCount()");
            result.next();
            int served = result.getInt(1);
            result = st.executeQuery("SELECT count(s_id) as total FROM sponsors");
            result.next();
            int sponsours = result.getInt(1);
            result = st.executeQuery("SELECT count(v_id) as total FROM volunteer");
            result.next();
            int volunteer = result.getInt(1);%>
<html lang="en">
  <head>
    <title>HOME - E Annapurna</title>
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">E Annapurna</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Created by <a href="#">K11 Group A</a></p>
    	...
    	<div class="container">
            ...
            <div class="block-18 color-1 align-items-stretch">
              <div class="text">
                ...
                <strong class="number" data-number="<%=served%>">0</strong>
                <span>People in 4 Areas in Pune</span>
              </div>
            </div>
          </div>
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-2 align-items-stretch">
              <div class="text">
              	...
              	<p>"We know that a peaceful world cannot long exist, one-third rich and two-thirds hungry." ~Jimmy Carter  </p>
              	<p><a href="donate.jsp" class="btn btn-white px-3 py-2 mt-2">Donate Now</a></p>
              </div>
            </div>
          </div>
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
              	...
              	<p>"If you want to eliminate hunger, everybody has to be involved."~Bono</p>
              	<p><a href="Volunteers.jsp" class="btn btn-white px-3 py-2 mt-2">Be A Volunteer</a></p>
              </div>
            </div>
          </div>
    		</div>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-4">
                ...
                <p>Unselfish and noble actions are the most radiant pages in the biography of souls.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
    ...
    <section class="ftco-section bg-light">
    	<div class="container-fluid">
          ...
          <div class="col-md-5 heading-section ftco-animate text-center">
            <h2 class="mb-4">Our Motivation</h2>
            <p>Close to a billion people one-eighth of the world's population still live in hunger. Each year 2 million children die through malnutrition. This is happening at a time when doctors in Britain are warning of the spread of obesity. We are eating too much while others starve.</p>
            <p>1 in 9 people don't have enough to eat</p>
          </div>
                    <div class="col-md-5 heading-section ftco-animate text-center">
            <h2 class="mb-4">Our Aim</h2>
            <p>Hunger is the single largest solvable problem in the world. We believe in a future where everybody in the world has access to clean and healthy food, no matter where they are, and what they can afford. </p>
          </div>
        </div>
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				...
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Ayan Gadpal</a></h3>
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				...
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Man Asi</a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
        	...
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				...
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html">Kalpit </a></h3>
        					<span class="position">Donated Just now</span>
        					<div class="text">
